...
from anastasia import airquality, confighelper, joke, loghelper, roomcommand, todolist, weather, nude, creds
...
def main():
    ...
    credits_handler = CommandHandler('credits', creds.give_credits)
